<div style="background-color: chocolate; margin-top: 0px;height: 70px;width: 100%;display: flex">
  <div style="width: 40%;">
  ...
  <div id="navi" style="width: 60%;height: 100%" align="right">
    <nav style=" margin-top: 20px ; height: 50%; width: inherit; margin-right: 10px">
      <div style="height: 100%">
        <input type="button" value="Login" style="height: 100%;width: 90px" onClick="login()"  >

        <input type="button" id="sign" value="Sign Up" style="height: 100%;width: 90px" onClick="signup()">
